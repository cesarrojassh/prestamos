...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('autocomplete.css')}}">
  ...
  <nav class="navbar navbar-expand align-items-center gap-4">
    ...
    <li class="nav-item dropdown d-none">
      ...
      <li class="nav-item d-md-flex d-none">
        <a class="nav-link position-relative d-none" data-bs-toggle="offcanvas" href="#offcanvasCart"><i class="material-icons-outlined">shopping_cart</i>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
          ...
          <hr class="dropdown-divider">
          <a type="radio" class="dropdown-item d-flex align-items-center gap-2 py-2" name="theme-options" id="DarkTheme"><i class="bi bi-moon"></i>Modo Dark</a>
          <a type="radio" class="dropdown-item d-flex align-items-center gap-2 py-2" name="theme-options" id="LightTheme"><i class="bi bi-brightness-high"></i>Modo Día</a>
          <a type="radio" class="dropdown-item d-flex align-items-center gap-2 py-2" name="theme-options" id="BlueTheme"><i class="bi bi-brightness-high"></i>Modo Blue</a>
          <a href="{{ route('logout') }}" class="dropdown-item d-flex align-items-center gap-2 py-2" name="theme-options" id="BlueTheme"><i class="bi bi-box-arrow-right"></i>Cerrar Sesión</a>
...
<!--end sidebar-->
    ...
    <div class="main-content">
      <!--breadcrumb-->
		<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
			<div class="breadcrumb-title pe-3"> @yield('title_content_ol')</div>
			<div class="ps-3">
			...
			<div class="ms-auto">
				<div class="btn-group">
			       @yield('content_rigth_optional')
				</div>
			</div>
		</div>
		<!--end breadcrumb-->
      
	  <div class="rounded-4" style="height:800px;">
        @yield('content')
	  </div>
  ...
  <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="staticBackdrop">
    <div class="offcanvas-header border-bottom h-70">
      <div class="">
        <h5 class="mb-0"> @yield('title_right')</h5>
      </div>
      <a href="javascript:;" class="primaery-menu-close" data-bs-dismiss="offcanvas">
        <i class="material-icons-outlined">close</i>
      </a>
