...
class LoginController extends Controller
{
    public function login(Request $request){
        ...
        $usuario = Users::where('usuario', $users)
        ...
        $modulos = DB::table('perfil_modulos')
                    ->join('modulos', 'perfil_modulos.modulo_id', '=', 'modulos.id')
                    ->where('perfil_modulos.perfil_id', $usuario->idperfil)
                    ->select('modulos.*')
                    ->get();
